...
type InfiniteQueryOptions<TResult> = QueryOptions<TResult> & {
 ...
 */
function parseUseGraphQLParams<TVariables, TResult>(
  variablesOrOptions?: TVariables | QueryOptions<TResult>,
  options?: QueryOptions<TResult>
): { variables?: TVariables; queryOptions?: QueryOptions<TResult> } {
  ...
  if (
    ...
    ('staleTime' in variablesOrOptions || 'retry' in variablesOrOptions || 'enabled' in variablesOrOptions || 'initialData' in variablesOrOptions)
  ) {
    return {
      variables: undefined,
      queryOptions: variablesOrOptions as QueryOptions<TResult>,
    }
  }
...
export function useInfiniteGraphQL<TResult, TVariables extends Record<string, unknown> & { page?: number; perPage?: number }>(
  ...
  options?: InfiniteQueryOptions<TResult>
