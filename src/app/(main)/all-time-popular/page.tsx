...
import { fetchMorePopularAnime } from "@/anilist/actions/anime-actions";
...
export default async function PopularPage(props: PopularPageProps) {
  ...
  return (
    <div className="">
      <h1 className="mb-8 text-3xl font-bold">All-Time Popular</h1>

      <Suspense fallback={<LoadingAnimeGrid count={perPage} />}>
        <InfiniteAnimeGrid
          initialAnime={animeList}
          initialHasNextPage={hasNextPage}
          loadMoreFunction={fetchMorePopularAnime}
          initialPage={page}
        />
      </Suspense>
    </div>
