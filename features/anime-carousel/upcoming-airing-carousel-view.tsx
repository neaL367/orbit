...
import { ErrorState, SectionHeader } from "@/features/shared"
import { Item } from "./item"
import type { Media } from "@/graphql/graphql"

type UpcomingAiringCarouselViewProps = {
  data: Media[]
  hideViewAll?: boolean
  className?: string
  error?: Error | null
...
export function UpcomingAiringCarouselView({
  data,
  hideViewAll = false,
  className,
  error,
  isLoading = false,
  onRetry,
}: UpcomingAiringCarouselViewProps) {
